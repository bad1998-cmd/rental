...
<?php
    ...
    $_dl1image=$_FILES['dl1']['name'];
          $query="INSERT INTO aftercar (unum, lnum, dl1, dl2, img,need) VALUES ('$n','$genre','$_dl1image','$_dl2image','$_image','$episode')";
